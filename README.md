...
For example, miku_v2 model for three.js is stored here: [/examples/models/mmd/miku/miku_v2.pmd](https://github.com/mrdoob/three.js/tree/r171/examples/models/mmd/miku/miku_v2.pmd)

Then you can get it from jsdelivr using the following url: https://cdn.jsdelivr.net/gh/mrdoob/three.js@r171/examples/models/mmd/miku/miku_v2.pmd
